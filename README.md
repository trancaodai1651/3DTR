...
2. Trong 3DTR, cấp quyền Drive/Sheets rồi chọn file trong danh sách hoặc dán link vào **Import file**. Link Excel dạng `drive.google.com/file/d/...` sẽ tự chuyển thành bản Google Sheet 3DTR trong My Drive.
3. File Excel phải được chia sẻ cho tài khoản đang đăng nhập và cho phép tải xuống; sau khi chuyển, ứng dụng kiểm tra đủ 15 sheet chuẩn trước khi chọn.
4. Để người khác dùng cùng file, chia sẻ file Google Sheet đã chuyển trong Google Drive với quyền Viewer hoặc Editor. Không cần làm công khai file dữ liệu.
